# Script used to reduce the dimensions of the data created. Adapted from the code written by Miguel Bernardo in his master degree thesis "Construction of Geometries Based on Automatic Text Interpretation". Auxiliary script, used in DataCreator.py and DataCreatorCorp2.py
